// src/pages/EmailVerificationHandler.js
// This component now serves as a landing page after Firebase default email verification.
...
const EmailVerificationHandler = () => {
  ...
  useEffect(() => {
    // After showing the message for a few seconds, redirect to the login page
    // ecotrakLogin.js will pick up the 'emailAction=verified' parameter.
    const timer = setTimeout(() => {
      navigate('/login?emailAction=verified');
    }, 3000); // 3-second delay
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md relative z-10 backdrop-blur-sm">
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 mb-6">
              Your email has been confirmed. You will be redirected to the login page shortly to continue.
            </p>
